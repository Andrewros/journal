const questions = [
  ...
  "What should you do in the morning when you feel like going back to sleep?",
  "What is the only way to be amazing at something",
...
const answers = [
  ...
  "If you tired, remember it will go away with time. If you had a good dream. Remember you won't really enjoy it with time now that you woke up and that you need to start the day. Good dreams are like a food that you liked after you had it but didn't enjoy while you did and the worst part is you rarely even remember them. This is a shitty drug you need to refuse to get addicted to.",
  "The only way to become the best at something is too both have a schedule that you are disciplined to follow but more important be adaptive of when you do it. You can't just do it when the schedule says to do it. It has to be your dream to get it done and you work for it even when it isn't scheduled. Think about your dream. And work for it. Remember the final law of power. Be fluid like water. Schedules are not ideal because they are too rigid. They can be helpful but you need to become someone who doesn't rely on them and can get things done regardless.",
