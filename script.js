const questions = [
  ...
  "What is the best problem to solve to win any game?",
  "What is the evilest way to win a game?",
  ...
  "Why should you always be present during conversations?",
  "Why should you love improving?",
...
const answers = [
  ...
  "1. Manipulate opponents model of reality 2. Attack the player not the game",
  ...
  "How can I manipulate my opponents model of reality? The most common form of this is making the opponent think they already won or already lost so they won't care anymore but there are other ways of doing this to.",
  "Attack the player not the game. Think about how Ayanokouji beat Ichinose in year 2 volume 12. Attacking the player can be much stronger as you can never assume you are better than anyone through sheer skill alone.",
  ...
  "It improves charisma as a habit and is also something that is very noticeable.",
  ...
  "Imagine every power fantasy you have. They are all realistic. Most people are lazy and as you train you are becoming the version of yourself that you love. Thus whenever you train visualize the person that you want to become looking back at yourself training and see how far you came.",
